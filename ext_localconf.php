...
(function() {
    ...
    $registry->registerFieldMapper(\Mediatis\Formrelay\ConfigurationResolver\FieldMapper\RawFieldMapper::class);
    ...
    $registry->registerValueMapper(\Mediatis\Formrelay\ConfigurationResolver\ValueMapper\PassthroughValueMapper::class);
